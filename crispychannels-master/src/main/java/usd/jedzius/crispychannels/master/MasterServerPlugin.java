...
public class MasterServerPlugin extends Plugin {
    ...
    public void onEnable() {
        ...
        final ProtocolServerWorker serverWorker = new ProtocolServerWorker(this.server, List.of(new UserTransferInfoHandler(), new ClientAuthorizationPayloadHandler(this.serverService)));
